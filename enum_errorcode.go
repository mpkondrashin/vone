...
// enum -package=vone -type=ErrorCode -names=NoError,AccessDenied,BadRequest,ConditionNotMet,InternalServerError,InvalidCredentials,NotFound,ParameterNotAccepted,RequestEntityTooLarge,TooManyRequests,Unsupported
// DO NOT EDIT!
